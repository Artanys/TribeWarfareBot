...
class TribeWarfareBotException(Exception):
...
class CommandError(TribeWarfareBotException):
    pass

# Something went wrong during the processing of a song/ytdl stuff
class ExtractionError(TribeWarfareBotException):
    pass
...
class HelpfulError(TribeWarfareBotException):
